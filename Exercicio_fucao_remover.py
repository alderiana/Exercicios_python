...
def remover_tarefa(descricao_procurada):
    """Busca uma tarefa pela descrição e a remove da lista."""
    encontrada = False
    ...
    for tarefa in lista_de_tarefas:
        ...
        if tarefa["descrição"].strip().lower() == descricao_procurada.strip().lower():
            ...
            print(f"\nTarefa '{tarefa['descrição']}' removida com sucesso!")
            encontrada = True
            break
    ...
    while True:
        ...
        if opcao == "1":
            ...
            if not lista_de_tarefas:
                ...
                nome_tarefa = input("Digite o nome exato da tarefa que deseja remover: ")
